...
const UserCard = () => {
    ...
    return (
        ...
        <img id='pfp' src={pfp} alt='augusto cohn'></img>
            <div className={styles.info}>
                <p>
                    <strong style={{color:'orange'}}>Hello!</strong> My name is Augusto Cohn and I am a master's student at Georgia
...
const Amazon = (props) => {
    ...
    return (
        <div className={styles.internship}>
            ...
            <div className={styles.skills}>
                <h3>Skills</h3>
                <Skills skills={skillsAmazon} color='#FF9900'/>
            </div>
        </div>
    )
}
...
const Trimble = (props) => {
    ...
    return (
        ...
        <div className={styles.skills}>
            <h3>Skills</h3>
            <Skills skills={skillsTrimble} color='#004f83'/>
        </div>
    </div>
    )
}
